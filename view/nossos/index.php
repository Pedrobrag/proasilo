...
<body>
    ...
    <main>
        <?php 
            if($_GET['tipo'] == 'parceiros'){ 
                $texto = 'Nenhum parceiro cadastrado';
            } else if($_GET['tipo'] == 'instituicoes'){
                $texto = 'Nenhuma instituição cadastrada';
            } else if($_GET['tipo'] == 'voluntarios'){
                $text = 'Nenhum voluntário cadastrado';
            }
        ?>
        <h2 class="nenhum"><?php echo $texto; ?></h2>
