...
<body>
    <header>
        <div class="topBackground">
            ...
            <div class="divIcone">
                <div class="tituloTela">CARÊNCIAS</div>
            </div>
        </div>
    </header>
    <main>
        <div class="top">
            <a href="../criarCarencia">
                <button id="addCarencia" type="button" class="btn btn-primary ">Adicionar carência</button>
            </a>
        </div>
        ...
        <div class="erro">Nenhuma carência registrada</div>
    </main>
    <footer>
