...
<head>
    ...
    <script src="../../controller/controller-trocarDados.js"></script>
...
<body>
    <header>
        ...
        <div class="mainNav">
            ...
            <div class="divIcone">
                <div class="tituloTela">ALTERAR DADOS</div>
            </div>
        </div>
    </header>
    <main>
        <div class="mainForm">
            ...
            <h2 class="erro"></h2>
            <button class="botao btn btn-success" onclick="trocarDados();">Salvar dados</button>
        </div>
    </main>
    <footer>
