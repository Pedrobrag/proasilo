...
<body>
    <header>
        <div class="topBackground">
            ...
            <div class="divIcone">
                <div class="tituloTela">PEDIDOS DE DOAÇÕES</div>
            </div>
        </div>
    </header>
    <main>
        <div class="top">
            <button onclick="aceitar()" disabled id="aceitar" type="button" class="btn btn-primary botao">Aceitar doação</button>
            <button onclick="recusar()" disabled id="recusar" type="button" class="btn btn-primary botao">Recusar doação</button>
        </div>
